 ...
 * COUNTY_REP must have the slug in their countySlugs claim. Anything else (APPLICANT,
 * unknown role) is denied. An empty list on a COUNTY_REP means "no counties assigned"
 * — never "all counties".
 *
