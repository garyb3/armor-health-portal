...
const badgeVariants = cva(
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ring-1 ring-inset",
  {
    variants: {
      variant: {
        default: "bg-gray-50 text-gray-900 ring-gray-500/10 dark:bg-gray-800 dark:text-gray-50 dark:ring-gray-600/30",
        NOT_STARTED: "bg-gray-50 text-gray-900 ring-gray-500/10 dark:bg-gray-800 dark:text-gray-50 dark:ring-gray-600/30",
